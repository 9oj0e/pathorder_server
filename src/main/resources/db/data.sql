...
INSERT INTO store_tb (username, password, owner_name, owner_tel, owner_email, biz_num, name, tel, intro, opening_time, closing_time, closed_day, address, latitude, longitude, img_filename, registered_at) VALUES
                                                                                                                                                                                                                ('david1234', '1234', '조정현', '010-1234-5678', 'david1234@gmail.com', '123-456-7890', '연의양과', '010-1234-5678', '까눌레와 다쿠아즈를 전문으로 하며, 매일 아침 제품들을 구워냅니다.', '07:00', '20:00', '매주 월요일', '부산 부산진구 서전로37번길 20 연의양과', '35.1587487392983', '129.064002552455', 'default/cafe1.png', NOW()),
