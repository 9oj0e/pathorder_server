...
(username, password, owner_name, owner_tel, owner_email, biz_num, name, tel, intro, opening_time, closing_time,
 closed_day, address, latitude, longitude, img_filename, registered_at)
VALUES ('david1234', '1234', '조정현', '01012345678', 'david1234@gmail.com', '123-456-7890', '연의양과', '01012345678',
       ...
       ('hana1234', '1234', '장현정', '01012345678', 'hana1234@gmail.com', '123-456-7890', '블랙업커피 서면본점', '01012345678',
        '블랙업커피 서면점은 2007년에 오픈하여 10년째 운영중인 메인 스토어 입니다.', '07:00', '20:00', '매주 목요일', '부산 부산진구 서전로10번길 41',
        '35.1560557306354', '129.059978704814',
        'default/cafe4.png', NOW()),
       ('qty1234', '1234', '최윤정', '01012345678', 'qty1234@gmail.com', '123-456-7890', '디저트 로지', '01012345678', '전포 누리마을 뒷쪽 골목 안에
아담하게 자리잡고 있습니다.', '07:00', '20:00', '매주 금요일', '부산 부산진구 서전로38번길 43-13 105호(전포동, 성진전자 상가) 디저트로지', '35.1559460199003',
        '129.064563982545', 'default/cafe5.png', NOW());
...
VALUES (1, '단밤 카페', 5, '찬혁', '아이스 아메리카노 엄청 뜨겁게 해주세요.', ((3600) + (3600) + (4700 + 500) + (5200 + 500) + (5200)),
        'SERVED',
...
-- order_id: 2
INSERT INTO order_tb (store_id, store_name, customer_id, customer_nickname, request, total_price, status, created_at)
VALUES (1, '단밤 카페', 2, '정현', '아이스 아메리카노 엄청 뜨겁게 해주세요.', ((3600) + (3600) + (4700 + 500) + (5200 + 500) + (5200)),
        'SERVED',
        DATEADD('DAY', -2, CURRENT_TIMESTAMP));
INSERT INTO order_menu_tb (order_id, name, qty, price, total_price, created_at)
...
-- order_id: 3
INSERT INTO order_tb (store_id, store_name, customer_id, customer_nickname, request, total_price, status, created_at)
VALUES (1, '단밤 카페', 3, '현정', '아이스 아메리카노 엄청 뜨겁게 해주세요.', ((3600) + (3600) + (4700 + 500) + (5200 + 500) + (5200)),
        'SERVED',
        DATEADD('DAY', -2, CURRENT_TIMESTAMP));
INSERT INTO order_menu_tb (order_id, name, qty, price, total_price, created_at)
...
-- order_id: 5
INSERT INTO order_tb (store_id, store_name, customer_id, customer_nickname, request, total_price, status, created_at)
VALUES (1, '단밤 카페', 4, '윤정', '후기 쓸게요. 에스프레소 샷 추가해주삼.', ((3500 + 500) + (3500 + 500) + (3500) + (4500 + 500) + (5000)),
        'SERVED',
        DATEADD('DAY', -1, CURRENT_TIMESTAMP));
INSERT INTO order_menu_tb (order_id, name, qty, price, total_price, created_at)
...
-- order_id: 7
INSERT INTO order_tb (store_id, store_name, customer_id, customer_nickname, request, total_price, status, created_at)
VALUES (1, '단밤 카페', 1, '성재', '아이스 아메리카노 엄청 뜨겁게 해주세요.', ((3600) + (3600) + (4700 + 500) + (5200 + 500) + (5200)),
        'SERVED',
        DATEADD('DAY', -1, CURRENT_TIMESTAMP));
INSERT INTO order_menu_tb (order_id, name, qty, price, total_price, created_at)
