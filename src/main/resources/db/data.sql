...
VALUES ('david1234', '1234', '조정현', '010-1234-5678', 'david1234@gmail.com', '123-456-7890', '연의양과', '010-1234-5678',
       ...
       ('qty1234', '1234', '최윤정', '010-5678-9012', 'qty1234@gmail.com', '567-890-1234', '디저트 로지', '010-5678-9012',
        ...
        NOW()),
       ('leetee1234', '1234', '박이태', '010-5184-7949', 'leetee1234@gmail.com', '507-209-4480', '카페이떼', '010-5184-7949',
        'Take away 전문점 입니다. 맛있는 커피와 샐러드, 샌드위치, 디저트를 판매합니다.', '07:30', '19:00', '매주 일요일', '부산 부산진구 중앙대로743번길 11 카페이떼',
        '35.1592549', '129.059527', 'default/cafe6.jpg', NOW());
